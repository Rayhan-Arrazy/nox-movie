    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 pt-6">
        ...
        <div class="text-center mb-10 animate-fade-in-up">
            <div class="w-14 h-14 rounded-2xl bg-[rgba(124,92,252,0.10)] flex items-center justify-center mx-auto mb-4">
                <i data-lucide="mail" class="w-7 h-7 text-[#a78bfa]"></i>
            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-5 mb-8">
            <div class="bg-[#0f0f22] rounded-2xl p-5 border border-white/5 text-center animate-fade-in-up"
                style="animation-delay: 80ms">
                <i data-lucide="mail" class="w-5 h-5 text-[#a78bfa] mx-auto mb-3"></i>
                <h3 class="text-xs font-bold text-white mb-1">Email</h3>
                <p class="text-[11px] text-gray-500">support@cineverse.com</p>
            </div>
            <div class="bg-[#0f0f22] rounded-2xl p-5 border border-white/5 text-center animate-fade-in-up"
                style="animation-delay: 160ms">
                <i data-lucide="map-pin" class="w-5 h-5 text-[#a78bfa] mx-auto mb-3"></i>
                <h3 class="text-xs font-bold text-white mb-1">Location</h3>
                <p class="text-[11px] text-gray-500">Jakarta, Indonesia</p>
            </div>
            <div class="bg-[#0f0f22] rounded-2xl p-5 border border-white/5 text-center animate-fade-in-up"
                style="animation-delay: 240ms">
                <i data-lucide="clock" class="w-5 h-5 text-[#a78bfa] mx-auto mb-3"></i>
        ...
        <!-- Contact Form -->
        <div class="bg-[#0f0f22] rounded-2xl p-5 sm:p-7 border border-white/5 animate-fade-in-up"
            style="animation-delay: 320ms">
            <h2 class="text-sm font-semibold text-white flex items-center gap-2 mb-5">
                <i data-lucide="send" class="w-4 h-4 text-[#a78bfa]"></i> Send a Message
            </h2>
            <form
            ...
            <div id="contact-success"
                class="hidden mt-4 px-4 py-3 rounded-xl bg-[rgba(124,92,252,0.10)] border border-[rgba(124,92,252,0.20)] text-sm text-[#a78bfa]">
