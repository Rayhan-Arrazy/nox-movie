    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-6">
        ...
        <div class="text-center mb-10 animate-fade-in-up">
            <div class="w-14 h-14 rounded-2xl bg-lime/10 flex items-center justify-center mx-auto mb-4">
                <i data-lucide="info" class="w-7 h-7 text-lime"></i>
            </div>
            <h1 class="text-3xl sm:text-4xl font-black font-display text-white mb-3">About <span
                    class="gradient-text">CineVerse</span></h1>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-5 mb-10">
            <div class="bg-dark-200 rounded-2xl p-6 border border-white/5 animate-fade-in-up"
                ...
                <div class="w-10 h-10 rounded-xl bg-lime/10 flex items-center justify-center mb-4">
        ...
        <!-- Team / Tech -->
        <div class="bg-dark-200 rounded-2xl p-6 sm:p-8 border border-white/5 animate-fade-in-up"
            style="animation-delay: 320ms">
            <h2 class="text-lg font-bold font-display text-white mb-4">Built With Love</h2>
            <p class="text-sm text-gray-500 leading-relaxed mb-6">CineVerse is a movie streaming platform built as a web
            ...
            <div class="flex flex-wrap gap-2">
                <?php foreach (['CodeIgniter 4', 'PHP 8', 'MySQL', 'Tailwind CSS', 'JavaScript', 'Lucide Icons', 'REST API'] as $tech): ?>
                    <span
                        class="px-3 py-1.5 rounded-lg text-[11px] font-medium bg-dark-300 text-gray-400 border border-white/5">
                        <?= $tech ?>
                    </span>
                <?php endforeach; ?>
            </div>
