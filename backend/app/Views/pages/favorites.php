        ...
        <div class="mb-6 animate-fade-in-up">
            <div class="flex items-center gap-3 mb-1">
                <div class="w-10 h-10 rounded-xl bg-[rgba(232,184,75,0.1)] flex items-center justify-center">
                    <i data-lucide="heart" class="w-5 h-5 text-[#e8b84b]"></i>
                </div>
                <div>
                    <h1 class="text-2xl font-bold font-display text-white">My Favorites</h1>
                    <p class="text-sm text-[#7a6e60]">Movies you've liked and saved</p>
                </div>
            </div>
        </div>
        ...
        <?php else: ?>
            ...
            <div class="bg-[#1a1714] rounded-2xl p-10 border border-white/5 text-center animate-fade-in-up">
                <div class="w-16 h-16 rounded-2xl bg-[rgba(232,184,75,0.1)] flex items-center justify-center mx-auto mb-4">
                    <i data-lucide="heart" class="w-8 h-8 text-[#e8b84b]"></i>
                </div>
                <h2 class="text-lg font-bold text-white font-display mb-2">Save Your Favorites</h2>
                <p class="text-sm text-[#7a6e60] mb-6 max-w-md mx-auto">Sign in to start saving movies you love and build
