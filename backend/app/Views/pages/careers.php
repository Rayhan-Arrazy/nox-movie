...
<div class="min-h-screen pb-10">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-6">
        ...
        <div class="text-center mb-10 animate-fade-in-up">
            <div class="w-14 h-14 rounded-2xl bg-[rgba(124,92,252,0.10)] flex items-center justify-center mx-auto mb-4">
                <i data-lucide="briefcase" class="w-7 h-7 text-[#a78bfa]"></i>
            </div>
        ...
        <div class="space-y-3">
            ...
            foreach ($positions as $i => $pos):
                ?>
                <div class="bg-[#0f0f22] rounded-2xl p-5 border border-white/5 flex flex-col sm:flex-row sm:items-center justify-between gap-4 animate-fade-in-up"
                    ...
                    <div>
                        ...
                        <div class="flex items-center gap-2">
                            <span
                                class="px-2 py-0.5 rounded-md text-[10px] font-medium bg-[rgba(124,92,252,0.10)] text-[#a78bfa] border border-[rgba(124,92,252,0.15)]">
                                <?= esc($pos[1]) ?>
                            </span>
                            <span
                                class="px-2 py-0.5 rounded-md text-[10px] font-medium bg-[#15152d] text-gray-400 border border-white/5">
                                <?= esc($pos[2]) ?>
                            </span>
                        </div>
                    </div>
                    <a href="/contact"
                        class="px-4 py-2 rounded-xl text-xs font-semibold text-[#a78bfa] bg-[rgba(124,92,252,0.10)] border border-[rgba(124,92,252,0.15)] hover:bg-[rgba(124,92,252,0.20)] transition-all flex-shrink-0 text-center">
                        Apply Now
                    </a>
                </div>
            <?php endforeach; ?>
        ...
        <!-- CTA -->
        <div class="mt-8 bg-[#0f0f22] rounded-2xl p-6 border border-white/5 text-center animate-fade-in-up">
