        ...
        <div class="mb-6 animate-fade-in-up">
            <div class="flex items-center gap-3 mb-1">
                <div class="w-10 h-10 rounded-xl bg-[rgba(124,92,252,0.1)] flex items-center justify-center">
                    <i data-lucide="bookmark" class="w-5 h-5 text-[#7c5cfc]"></i>
                </div>
                <div>
                    <h1 class="text-2xl font-bold font-display text-white">My Collections</h1>
                    <p class="text-sm text-[#6b6b9a]">Your bookmarked movies & watchlist</p>
                </div>
            </div>
        </div>
        ...
        <?php else: ?>
            ...
            <div class="bg-[#0f0f22] rounded-2xl p-10 border border-white/5 text-center animate-fade-in-up">
                <div class="w-16 h-16 rounded-2xl bg-[rgba(124,92,252,0.1)] flex items-center justify-center mx-auto mb-4">
                    <i data-lucide="bookmark" class="w-8 h-8 text-[#7c5cfc]"></i>
                </div>
                <h2 class="text-lg font-bold text-white font-display mb-2">Build Your Watchlist</h2>
                <p class="text-sm text-[#6b6b9a] mb-6 max-w-md mx-auto">Sign in to bookmark movies and create your personal
                    watchlist.</p>
