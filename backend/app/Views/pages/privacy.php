...
<div class="min-h-screen pb-10">
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 pt-6">
        ...
        <div class="bg-[#0f0f22] rounded-2xl p-6 sm:p-8 border border-white/5 space-y-6 animate-fade-in-up"
            ...
            $sections = [
                ...
                ['How We Use Your Information', 'Your information is used to provide and personalize the NOX Movie service, including movie recommendations, favorites, and watchlist features. We never sell your personal data to third parties.'],
                ...
                ['Cookies & Sessions', 'NOX Movie uses session cookies to keep you logged in and remember your preferences. These cookies are essential for the service to function properly.'],
            ...
            foreach ($sections as $i => $section):
                ...
                <div>
                    <h2 class="text-sm font-bold text-white mb-2 flex items-center gap-2">
                        <span
                            class="w-6 h-6 rounded-lg bg-[rgba(124,92,252,0.12)] text-[#a78bfa] text-[10px] font-bold flex items-center justify-center">
                            <?= $i + 1 ?>
                        </span>
                        <?= esc($section[0]) ?>
                    </h2>
            ...
            <div class="pt-4 border-t border-white/5">
                <p class="text-xs text-gray-600">If you have questions about this privacy policy, please <a
                        href="/contact" class="text-[#a78bfa] hover:underline">contact us</a>.</p>
            </div>
        </div>
    </div>
</div>
