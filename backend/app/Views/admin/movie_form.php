...
<div class="min-h-screen pb-10">
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 pt-6">
        ...
        <!-- Form -->
        <div class="bg-dark-200 rounded-2xl p-5 sm:p-7 border border-white/5">
            ...
            <form action="<?= $isEdit ? '/admin/movies/update/' . $movie['id'] : '/admin/movies/store' ?>" method="POST"
                ...
                <div class="flex items-center gap-6 pt-2">
                    <label class="flex items-center gap-2 cursor-pointer">
                        ...
                        class="w-4 h-4 rounded bg-dark-300 border-gray-600 text-lime focus:ring-lime/30" />
                ...
                <div class="flex items-center gap-3 pt-4 border-t border-white/5">
                    ...
                    <a href="/admin"
                        class="px-5 py-2.5 rounded-xl text-sm font-medium text-gray-500 bg-dark-300 border border-white/5 hover:text-white transition-all">Cancel</a>
                </div>
            </form>
        </div>
    </div>
